...
const isLastInStock = cars => _.compose( _.prop('in_stock') ,_.last)(cars)
...
const averageDollarValue = cars => _.compose(_average,  _.map(_.prop('dollar_value')))(cars)
...
const sanitizeNames = cars => _.map(_.compose(_underscore, _.toLower, _.prop('name')), cars)
